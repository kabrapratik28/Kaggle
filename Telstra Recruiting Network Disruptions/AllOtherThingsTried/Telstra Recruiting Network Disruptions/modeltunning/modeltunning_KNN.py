...
param_dist = {
             "n_neighbors":[1,2,4,8,16,35,64,128,256],
             "weights":['uniform','distance'], 
             "algorithm":['auto'], 
             "leaf_size":[8,16,30,40,50], 
...
with open("knnbest.txt", "w") as myfile:
...
clf = KNeighborsClassifier(algorithm='auto', leaf_size=50, metric='euclidean',
