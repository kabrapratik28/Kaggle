...
num_features = dataset_train_sel_fea_val.shape[1]

# build a classifier
clf =  net0 = NeuralNet(layers=layers0,
...
param_dist = {  
    "dropoutf_p" : [0.1,0.3,0.4],
    "dense0_num_units":[400,500,600,800],
    "dropout_p":[0.1,0.3,0.4],
    "dense1_num_units":[400,500,600,800],
    "dropout2_p":[0.1,0.3,0.4],
    "dense2_num_units":[400,500,600,800],
    "update":[nesterov_momentum],
    "update_learning_rate":[0.1,0.008,0.005],
    "eval_size":[0.1,0.2,0.3],
    "max_epochs":[35,40,45]
             }

X_train_32 = dataset_train_sel_fea_val.astype(np.int32)
Y_train_32 = dataset_train_ans_val.astype(np.int32)
...
random_search.fit(X_train_32, Y_train_32 )

print("RandomizedSearchCV took %.2f seconds for %d candidates"
      " parameter settings." % ((time() - start), n_iter_search))

with open("Lasagnebest.txt", "w") as myfile:
